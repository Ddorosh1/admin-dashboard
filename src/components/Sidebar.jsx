...
const Sidebar = () => {
  ...
  const normalLink = 'flex items-center gap-5 pl-4 pt-3 m-2 pb-2.5 rounded-lg text-gray-700 text-md dark:text-gray-200 dark:hover:text-black hover:bg-light-gray';

  return (
    <div className='ml-3 h-screen md:overflow-hidden overflow-auto md:hover:overflow-auto pb-10 pt-10'>
      {activeMenu && (<>
